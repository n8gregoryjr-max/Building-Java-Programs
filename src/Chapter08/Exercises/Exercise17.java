...
if, when this Line is stretched infinitely, it would eventually hit the given Point.
...
between each pair of points and checking whether this slope is the same for all pairs of points.
